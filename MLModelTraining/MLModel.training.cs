...
namespace MLModelTraining
{
    public partial class MLModel
    {
        public const string RetrainConnectionString = @"Data Source=FEDERICO-PC\SQLEXPRESS;Initial Catalog=AdventureWorksLT2019;Integrated Security=True;Trust Server Certificate=True";
        public const string RetrainCommandString = @"SELECT CAST([ReviewText] as NVARCHAR(MAX)), [Class] FROM [dbo].[Reviews]";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"ReviewText",outputColumnName:@"ReviewText")      
                                    ...
                                    .Append(mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.0417905F,LabelColumnName=@"Class",FeatureColumnName=@"Features"}));
