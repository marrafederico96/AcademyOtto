...
namespace AuthLibrary.Repository
{
    ...
    public interface ICustomerSecurityRepository
    {
        ...
        /// </returns>
        Task<bool> InsertCustomerSecurityAsync(UserRegisterRequest userData, int customerID);
        ...
        /// </summary>
        /// <param name="email">Email of the customer to search for.</param>
        /// <returns>
        /// Returns a <see cref="UserSecurityData"/> object if the customer is found; otherwise, <c>null</c>.
        /// </returns>
        Task<UserSecurityData?> GetCustomerSecurityByEmailAsync(string email);
        ...
        /// </returns>
        Task<bool> DeleteCustomerSecurityAsync(int customerID);
        ...
        Task RollbackCustomerSecurity(UserSecurityData userData);
    }
}
